...
urlpatterns = patterns('placard.lusers',
    ...
    url(r'^(?P<username>[-.\w]+)/groups/$', 'views.users_groups', name='plac_users_groups'),
    ...
    url(r'^(?P<username>[-.\w]+)/lock/$', 'views.lock_user', name='plac_lock_user'),
    url(r'^(?P<username>[-.\w]+)/unlock/$', 'views.unlock_user', name='plac_unlock_user'),
)
