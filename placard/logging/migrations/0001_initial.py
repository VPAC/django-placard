...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logging_logentry', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ldap_logs', to=orm['auth.User'])),
            ('object_dn', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('object_pk', self.gf('django.db.models.fields.CharField')(max_length=20)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 1, 4, 40, 187851, tzinfo=<UTC>)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 1, 4, 40, 187780, tzinfo=<UTC>)'}),
        ...
        'logging.logentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_dn': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'object_pk': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'object_repr': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'object_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ldap_logs'", 'to': "orm['auth.User']"})
        }
    }
